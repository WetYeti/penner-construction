        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-8 bg-slate-50 rounded-xl">
              ...
              <a href="tel:9035550123" className="text-2xl font-bold text-slate-900">
                (903) 555-0123
              </a>
            ...
            <div className="text-center p-8 bg-slate-50 rounded-xl">
              ...
              <p className="text-slate-900 font-semibold">Penner Construction</p>
              <p className="text-slate-600">456 Builder Lane, Carthage, TX 75633</p>
            </div>
          </div>
