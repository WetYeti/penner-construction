      ...
      <section className="relative bg-gradient-to-br from-slate-900 to-slate-800 text-white min-h-[80vh] flex items-center">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6">Penner Construction</h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-slate-900 mb-6">About Penner Construction</h2>
            ...
            <div className="bg-slate-200 h-80 rounded-xl flex items-center justify-center">
              <p className="text-slate-500">Penner Construction - Serving Carthage Since 1990</p>
            </div>
          </div>
        </div>
      </section>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white p-8 rounded-xl shadow-md">
                ...
                <p className="text-slate-600 mb-6">
                  "Excellent service! Highly recommend Penner Construction for quality general contractor work."
                </p>
